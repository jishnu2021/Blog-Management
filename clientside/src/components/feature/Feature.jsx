...
function Feature() {
    return (
        <>
            <div id="blog" className="bg-gray-100 px-4 xl:px-0 py-12" style={{marginTop:'5rem'}}>
                <div className="mx-auto container">
                    <h1 className="text-center text-3xl lg:text-5xl tracking-wider text-gray-900" style={{marginBottom:'2rem',fontFamily:'sans-serif',fontWeight:'700'}}>Latest from our Blog</h1>
